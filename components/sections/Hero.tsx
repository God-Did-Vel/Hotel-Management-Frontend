...
const SLIDES = [
  "https://res.cloudinary.com/duweg8kpv/image/upload/t5_iimlr7.jpg",
  "https://res.cloudinary.com/duweg8kpv/image/upload/t15_rarzhd.jpg",
  "https://res.cloudinary.com/duweg8kpv/image/upload/t14_kzkydt.jpg",
  "https://res.cloudinary.com/duweg8kpv/image/upload/360_F_692511356_6jleOpKpvIMrGRtXo7TZk70aD8ePbZvQ_q7ahz9.jpg",
];
  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 text-center px-6">
        ...
        >
          Experience uncompromised luxury and unparalleled comfort in the heart
          of the city.
        </motion.p>
